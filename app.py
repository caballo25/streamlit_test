...
def main():
    st.title("Visualización de Forecast con Streamlit y Plotly")

    # CSV en Google Drive
    csv_url = 'https://drive.google.com/uc?https://drive.google.com/uc?id=1Lv-1RupyJ55Ip-fE1JSb7C-esOUZy__K'  
